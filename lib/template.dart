...
/// The header to use.
///
/// Typically this is copyright information.
String _header = '';
...
/// Sets the [value] of the header to use during generation.
///
/// The header is typically used to hold copyright information. It is assumed
/// that it contains lines that are commented out.
///
/// This will overwrite the current header and any subsequent calls to
/// [renderLibrary] will use this header.
